package com.petreca.petrecadelivery.delivery.tracking.infrastructure.doc;
...
@Configuration
@OpenAPIDefinition(
        info = @Info(title = "Delivery Tracking API", version = "v1", contact = @Contact(name = "Weriton L. Petreca", email = "eulcfr@gmail.com", url = "https://weriton.dev")),
